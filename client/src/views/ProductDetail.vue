            ...
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-text pb-3">
                  배송비 {{getCurrencyFormat(productDetail.delivery_price)}} | 도서산관(제주도) 배송비 추가 {{getCurrencyFormat(productDetail.add_delivery_price)}} | 택배배송 | {{productDetail.outbound_days}}일 이내 출고 (주말, 공휴일 제외)
                </p>
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div class="col-6 d-grid p-1">
                    <button type="button" class="btn btn-lg btn-warning">장바구니 담기</button>
                  </div>
                  <div class="col-6 d-grid p-1">
                    <button type="button" class="btn btn-lg btn-warning">주문하기</button>
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  created(){
    this.productId = this.$route.query.product_id; //페이지에 들어가서 경로뒤에있는 파라미터값을 가져와야할 때 쓴다.   
